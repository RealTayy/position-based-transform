...
## Getting Started
Currently the only way to use Position Based Transform is to manually [download](https://github.com/RealTayy/position-based-transform/files/2720318/position-based-transform-v1.2.1.zip) and link `positionBasedTransform.min.js` in your HTML
```html
<body>
